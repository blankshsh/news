$(function() {
    ...
    $(document).on('click', '.update', function(e) {
        ...
        // if (newstype== 'type1') {
        //      $("#update #changetype1").attr('selected','');//value
        // }else if(newstype=='type2'){
        //     $("#update #changetype2").attr('selected','');
        // }else{
        //     $("#update #changetype3").attr('selected','');
        // };//判断是什么类型的新闻
        if (newstype== 'type1') {
             $("#update #changetype1").attr('checked','');
        }else if(newstype=='type2'){
            $("#update #changetype2").attr('checked','');
        }else{
            $("#update #changetype3").attr('checked','');
        };
        ...
        if (do_delete) {
            $.ajax({
                ...
                data: {
                    ...
                    token: $(location).parents(".index-list-item").children("input").attr("value")
                },
